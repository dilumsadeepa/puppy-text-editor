...
const Toolbar = ({
  ...
  const addTable = async () => {
    ...
    const className = await handleModal('Select Table Style: [puppy-table-bordered, puppy-table-hover, puppy-table-striped, puppy-table-dark, puppy-table-borderless]');

    setCursorPos(pos);
    if (rows && columns) {
      let tableCode = '<div class="puppy-table-responsive">';

      tableCode += `<table class="puppy-table ${className}" style="border: 1px solid black;" >`;
